...
let examples = {
    ...
    styling3: baseurl + 'labels.yaml' + '&lines=5,28-35',
    ...
    vector: baseurl + 'vector.yaml' + '&lines=4,10,19',
    vector2: baseurl + 'vector2.yaml' + '&lines=15,24',
    vector3: baseurl + 'vector3.yaml' + '&lines=25-33' + '#6/39.130/-118.224',
    vector4: baseurl + 'vector4.yaml' + '&lines=34-39' + '#13/40.8125/-73.9282',
    vector5: baseurl + 'vector5.yaml' + '&lines=34-42' + '#14/40.7180/-74.0020',
    vector6: baseurl + 'vector6.yaml' + '&lines=43-53' + '#14/40.7180/-74.0020',
    vector7: baseurl + 'vector7.yaml' + '&lines=53-59' + '#14/40.7180/-74.0020',
